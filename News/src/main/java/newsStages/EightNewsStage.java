...
public class EightNewsStage {
	private ImageView imagem;
	private ImageView imagemEscritor;
	
	public EightNewsStage(Stage stage) {
		BorderPane borderpane = new BorderPane();
		ScrollPane scrollPane = new ScrollPane(borderpane);
		scrollPane.setFitToHeight(true);
		scrollPane.setVbarPolicy(ScrollBarPolicy.ALWAYS);
		borderpane.setPrefSize(1280, 720);
	    imagem = new ImageView(new Image("img8.jpg"));
	    imagem.setFitHeight(428);
	    imagem.setFitWidth(720);
	    Strings.subtitleNot8.setFont(ITALIC_FONT);
	    Strings.subtitleNot8.setFill(Color.WHITE);    
	    Strings.titleNot8.setFont(new Font(40));
	    Strings.titleNot8.setFill(Color.WHITE);
	    Button btVoltar = new Button("Voltar");
	    Label title = new Label(null, new TextFlow(new Text("\n"), btVoltar, new Text("\n"), Strings.titleNot8, new Text(", \n"), Strings.subtitleNot8));
	    borderpane.setTop(title);
	    BorderPane.setAlignment(title, Pos.CENTER);
	    borderpane.setCenter(imagem);
	    BorderPane.setAlignment(imagem, Pos.CENTER);
	    Strings.not8.setFont(new Font(20));
	    Strings.not8.setFill(Color.WHITE);
